...
`shawarma 12.5` are parsed and answered directly for reads
(summary, breakdown, list) or shown with [Confirm]/[Cancel]
for writes — nothing is written before you confirm.
