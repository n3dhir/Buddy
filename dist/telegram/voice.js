...
export async function transcribeVoice(fileId, botToken, durationSec) {
    ...
    try {
        ...
        try {
            ...
            throw new VoiceUnavailable(`Transcription failed (${e instanceof Error ? e.message : e}) — check WHISPER_BIN/WHISPER_MODEL.`);
        }
