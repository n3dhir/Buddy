...
export function getToken(): string | null {
  // buddy_* keys; fall back to legacy rafiq_* so existing logins survive.
  return localStorage.getItem("buddy_token") ?? localStorage.getItem("rafiq_token");
}
...
export function getUser(): AuthUser | null {
  try {
    const raw = localStorage.getItem("buddy_user") ?? localStorage.getItem("rafiq_user");
